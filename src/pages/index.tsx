...
const IndexPage = props => {
  ...
  return (
    <Layout>
      <SEO title="Home" />
      <Image position="absolute" zIndex="1" left="0px" bottom="0px" w={{lg: "1080px", md: "920px"}} src={erifranckGuapo} />
      <Flex justifyContent="flex-end" w="calc(100% - 300px)" m="auto" mt="60px">
        {sections.map(section => (
          <Box ml="100px" key={section.title}>
            <Card title={section.title} image={section.img} actionLabel={section.actionLabel} />
          </Box>
        ))}
      </Flex>
    </Layout>
